...
public class Candle {
  ...
  private Instant timestamp =
      Instant.now()
          .truncatedTo(
              java.time.temporal.ChronoUnit.MINUTES); // TODO: check starting of all minutes

  @ManyToOne(
      fetch = FetchType.LAZY,
      cascade =
          CascadeType
              .PERSIST) // TODO: this is to make sure stock is persisted when candle is saved, check
  // once
